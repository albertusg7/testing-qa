...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/h3_Epic sadface Sorry, this user has been l_a91fd7'))

WebUI.verifyElementText(findTestObject('Page_Swag Labs/h3_Epic sadface Sorry, this user has been l_a91fd7'), 'Epic sadface: Sorry, this user has been locked out.')
